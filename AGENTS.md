...
*   **Hooks Verification:** If modifying Go source files, execute [.gemini/lint.sh](file:///home/igor/Documents/projetos/don/.gemini/lint.sh) (or `.agents/lint.sh` if active) to verify code style and lints.
